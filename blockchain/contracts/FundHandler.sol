...
contract FundHandler {
    ...
    function wrap(address addr, bytes32 symbol, uint256 amount) public returns (bool) {
    ...
    function getBalance(address addr, bytes32 symbol) public view returns (uint256) {
    ...
    function transfer(address _loan, address _src, address _dst, uint256 _amount, bytes32 _symbol) public returns (bool) {
